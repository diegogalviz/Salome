    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_join', models.DateField(default=datetime.datetime.now, verbose_name='Fecha de registro')),
                ...
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.type_employeed')),
            ],
            options={
