# Generated by Django 4.2.1 on 2023-05-22 22:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cli', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.client')),
            ],
            options={
                'verbose_name': 'Venta',
        ...
        migrations.AddField(
            model_name='detsale',
            name='sale',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.sale'),
        ),
    ]
